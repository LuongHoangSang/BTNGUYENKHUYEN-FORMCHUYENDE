...
\def\tren{1.75}\def\duoi{2}\def\trai{1.5}\def\phai{1} %cách lề
...
\def\khoi{10}
\def\tieudetrenchuong{ÔN TẬP KIỂM TRA CUỐI HỌC KÌ 2}
\def\SDTi{09.6175.0612}
\def\noidungduoitrai{{\color{\maukefoot}\faHome\,\, Trường THCS - THPT Nguyễn Khuyến}}
\def\noidungduoiphai{\color{\maukefoot} GV: Sang Hoàng Lương}
%%--
...
%\input{data17/BTMASAT}
%\input{data17/soande}
%\setcounter{chapter}{6}
%\input{data17/DONGLUONG}\newpage
% ========== ÔN TẬP KIỂM TRA CUỐI HỌC KÌ 2
\setcounter{chapter}{5}
\input{data17/CHUONG6}\newpage
\input{data17/CHUONG7}
\input{data17/CHUONG8}
%==================Mục lục chính
